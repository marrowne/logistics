...
var Button = function (props) {
    ...
    return isXSmall ? (label && !disabled ? (react_1.default.createElement(core_1.Tooltip, { title: translate(label, { _: label }) },
        react_1.default.createElement(core_1.IconButton, __assign({ "aria-label": translate(label, { _: label }), className: className, color: color }, restProps), children))) : (react_1.default.createElement(core_1.IconButton, __assign({ className: className, color: color, disabled: disabled }, restProps), children))) : (react_1.default.createElement(core_1.Button, __assign({ className: classnames_1.default(classes.button, className), color: color, size: size, "aria-label": label ? translate(label, { _: label }) : undefined, disabled: disabled }, restProps),
        alignIcon === 'left' &&
            children &&
