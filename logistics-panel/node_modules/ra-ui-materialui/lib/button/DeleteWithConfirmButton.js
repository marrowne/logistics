...
var DeleteWithConfirmButton = function (props) {
    ...
    var _g = ra_core_1.useDelete(resource, record.id, record, {
    ...
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement(Button_1.default, __assign({ onClick: handleClick, label: label, className: classnames_1.default('ra-delete-button', classes.deleteButton, className), key: "button" }, rest), icon),
