...
exports.BooleanField = function (_a) {
    ...
    if (value === false || value === true) {
        return (react_1.default.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)),
            react_1.default.createElement(core_1.Tooltip, { title: translate(ariaLabel, { _: ariaLabel }) }, value === true ? (react_1.default.createElement(Done_1.default, { "data-testid": "true" })) : (react_1.default.createElement(Clear_1.default, { "data-testid": "false" })))));
    }
