...
public class CourierDelivered implements DomainEvent {
    ...
    public CourierDelivered(Courier courier, long parcelId, ParcelStatus previousStatus, ParcelStatus newStatus) {
