...
public class CourierReceived implements DomainEvent {
    ...
    public CourierReceived(Courier courier, long parcelId, ParcelStatus previousStatus, ParcelStatus newStatus) {
