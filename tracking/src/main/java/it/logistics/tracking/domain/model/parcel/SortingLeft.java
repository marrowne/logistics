...
public class SortingLeft implements DomainEvent {
    ...
    public SortingLeft(SortingWorker sortingWorker, long parcelId, ParcelStatus previousStatus, ParcelStatus newStatus) {
