...
public class HttpEmployeeAdapterTest {
    ...
    public void testBuildURLFor() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        // given
        Method method = HttpEmployeeAdapter.class.getDeclaredMethod("buildURLFor", String.class, String.class, String.class, String.class);
